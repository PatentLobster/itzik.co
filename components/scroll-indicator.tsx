...
export function ScrollIndicator({ targetId }: ScrollIndicatorProps) {
  ...
  return (
    ...
    >
      ...
      <motion.div
        className="w-px h-12 mt-1 bg-gradient-to-t from-slate-300 to-transparent dark:from-slate-600 dark:to-transparent group-hover:from-blue-400 dark:group-hover:from-blue-500 transition-colors duration-300"
        initial={{ height: 0 }}
        animate={{ height: 48 }}
