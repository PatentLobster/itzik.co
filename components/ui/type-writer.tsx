...
export const useTypingText = ({
  ...
  useEffect(() => {
    ...
    let intervalSpeed = direction.current === FORWARD ? typingSpeed : erasingSpeed
  ...
  }, [wordIndex, typingSpeed, erasingSpeed, words, maxPauseAmount, isStopped])
    ...
    <span className={cn("text-xl text-pink-500", space.className)}>
      ...
      <span
        className={cn(
          ...
          "ml-1 bg-pink-500 font-sans text-lg"
        )}
      >
        &nbsp;
      </span>
